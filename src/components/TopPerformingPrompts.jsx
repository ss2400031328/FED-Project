...
export function TopPerformingPrompts() {
  ...
  return /*#__PURE__*/React.createElement(Card, {
  ...
  }, "Top Performing Prompts"), /*#__PURE__*/React.createElement(CardDescription, {
    className: "text-ai8-gray font-medium"
  }, "Prompts driving the highest visibility and mentions")), /*#__PURE__*/React.createElement("button", {
    className: "ai8-button-secondary gap-2 flex items-center"
  }, "View All", /*#__PURE__*/React.createElement(ArrowUpRight, {
    className: "w-4 h-4"
  }))), /*#__PURE__*/React.createElement(CardContent, {
    className: "space-y-5"
  }, prompts.map(prompt => /*#__PURE__*/React.createElement("div", {
    key: prompt.id,
    ...
    className: "text-sm font-semibold text-ai8-navy leading-relaxed"
  }, prompt.text)), /*#__PURE__*/React.createElement(Badge, {
    className: `${getStatusColor(prompt.status)} font-semibold px-3 py-1`
  }, prompt.status)), /*#__PURE__*/React.createElement("div", {
    className: "space-y-4"
  }, /*#__PURE__*/React.createElement("div", {
    ...
    className: "text-sm font-bold text-ai8-navy"
  }, prompt.mentions.toLocaleString()))), /*#__PURE__*/React.createElement(Badge, {
    className: "bg-ai8-success/20 text-ai8-success border-ai8-success/30 font-bold px-3 py-1"
  }, prompt.growth)), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
